...
namespace Svr.Web.Controllers
{
    public class DirsController : Controller
    {
        ...
        public async Task<IActionResult> Details(long? id)
        {
            ...
            var model = new ItemViewModel { Id = item.Id, Name = item.Name, DirNameId = item.DirNameId, DirName = item.DirName, StatusMessage = StatusMessage, CreatedOnUtc = item.CreatedOnUtc, UpdatedOnUtc = item.UpdatedOnUtc };
            return View(model);
        }
        #endregion
        #region Create
