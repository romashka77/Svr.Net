...
{
    public class SortRegionsTagHelper : TagHelper
    {
        ...
        #region конструктор
        public SortRegionsTagHelper(IUrlHelperFactory helperFactory)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (((Current == SortState.CodeAsc) && (Property == SortState.CodeDesc)) || ((Current == SortState.CodeDesc) && (Property == SortState.CodeAsc)) || ((Current == SortState.NameAsc) && (Property == SortState.NameDesc)) || ((Current == SortState.NameDesc) && (Property == SortState.NameAsc)))
            {
